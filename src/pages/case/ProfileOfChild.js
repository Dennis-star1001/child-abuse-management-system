...
export const ProfileOfChild = ({ children }) => {
    let { id } = useParams();
            ...
            {Data && (
                <>
                    <Flex alignItems={'center'} borderRadius={'2xl'} border='1px solid #E2E8F0' gap='5' p='7'>
                        ...
                        <Box w='full' bg='white'>
                            <Text fontSize={'lg'} fontWeight={'medium'}>{Data.firstname} {Data.lastname}</Text>
                            <Text color={'#A5AEBB'} fontSize={'sm'}>{Data.email}</Text>
                            <Text color={'#A5AEBB'} fontSize={'sm'}>{Data.phone}</Text>
                        </Box>
                        {/* ))} */}
                    </Flex>
