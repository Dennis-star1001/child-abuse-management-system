        ...
        <Box  pl='64'>
            <div class="mx-auto max-w-7xl  sm:px-6 lg:px-8 ">
                <div class='flex justify-end'>
                    <button class='bg-[#696BC2] text-white px-5 py-2 ' onClick={() => setOpen(true)}>Add Child</button>

                </div>

                <dt class="text-[#6C6573] font-medium py-2"></dt>
                <div class=" rounded-lg border border-[#F2F2F4] h-40 w-full">

                    <div class="relative overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                <tr class="border-b  border-[#F3F3F3] bg-[#F9FBFC] ">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white font-medium dark:bg-gray-800 border-b border-[#F3F3F3]">
                                    ...
                                    <td class="px-6 py-4 ">
                                        <button
                                            type="button"
                                            class="font-medium p-2 mr-1 text-white hover:text-indigo-500 bg-[#696BC2]">
                                            Edit
                                        </button>
                                        <button
                                            type="button"
                                            class="font-medium p-2 mx-1 text-white hover:text-indigo-500 bg-[#FF0000]">
                                            Delete
                                        </button>
                                    </td>
                    ...
                    <div class="fixed inset-0 overflow-hidden">
                        <div class="absolute inset-0 overflow-hidden">
                            <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                                ...
                                >
                                    <Dialog.Panel class="pointer-events-auto relative w-screen max-w-md">
                                        <Transition.Child
                                            as={Fragment}
                                            enter="ease-in-out duration-500"
                                            enterFrom="opacity-0"
